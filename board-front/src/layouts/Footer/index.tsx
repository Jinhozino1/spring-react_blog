        ...
        <div className='footer-container'>
            <div className='footer-top'>
                <div className='footer-logo-box'>
                    ...
                    <div className='footer-logo-text'>{'Jinho Board'}</div>
                </div>
                <div className='footer-link-box'>
                    <div className='footer-email-link'>{'skvofj014@naver.com'}</div>
            ...
            <div className='footer-bottom'>
                <div className='footer-copyright'>{'Copyright © 2025 Jinho. Rights Reserved.'}</div>
            </div>
        </div>
    </div>
  )
