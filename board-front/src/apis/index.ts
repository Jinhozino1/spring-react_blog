...
const GET_SIGN_IN_URL = () => `${API_DOMAIN}/user:1`;
...
// axios.get(GET_SIGN_IN_URL(), { withCredentials: true });

// export const getSignInUserRequest = async () => {
//     const result = await axios.get(GET_SIGN_IN_URL(), { withCredentials: true })
